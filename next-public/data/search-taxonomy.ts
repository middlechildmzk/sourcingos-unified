...
export const TITLES: TaxonomyEntry[] = [
  ...
  { canonical: 'ML Engineer',            type: 'title', color: 'title',
    aliases: ['ml engineer', 'machine learning engineer', 'ai engineer', 'ai/ml engineer', 'mlops engineer', 'ml ops engineer'] },
  ...
  { canonical: 'Federal Recruiter',      type: 'title', color: 'title',
    aliases: ['federal recruiter', 'government recruiter', 'govcon recruiter', 'cleared recruiter', 'cleared talent', 'cleared recruiting'] },
  { canonical: 'Proposal Manager',       type: 'title', color: 'title',
    aliases: ['proposal manager', 'capture manager', 'proposal coordinator', 'proposal writer', 'business development', 'bd manager'] },
...
export const CLEARANCES: TaxonomyEntry[] = [
  ...
  { canonical: 'Secret',      type: 'clearance', color: 'clearance',
    aliases: ['secret clearance', 'secret'] },
...
export const INDUSTRIES: TaxonomyEntry[] = [
  ...
  { canonical: 'AI/ML',         type: 'industry', color: 'industry',
    aliases: ['ai/ml', 'ai ml', 'artificial intelligence', 'machine learning industry', 'ai startup', 'ai company'] },
