...
const tasks = [
  ...
  ['4. Candidate discovery','On the same requisition and time window, measure reviewed candidates, qualified candidates, duplicates, and unique candidates that another lane did not surface. Do not compare raw database-size marketing claims.'],
  ['5. Evidence accuracy','For each surfaced candidate, verify a sample of claims against the underlying profile or public evidence. Score unsupported claims, stale facts, incorrect employer/title interpretation, and missing provenance.'],
  ...
  ['7. Recruiter control','Test whether the recruiter can inspect filters, qualifications, query logic, evidence, exclusions, and why the system made a recommendation. Black-box convenience should not be scored as equivalent to controllable search.'],
...
const scorecard = [
  ['Search-quality lift','Does AI help the recruiter reach qualified people a sensible manual baseline misses?'],
  ['Unique contribution','What qualified candidates did this workflow add that the comparison workflow did not?'],
  ['Evidence fidelity','Are candidate claims traceable to real source evidence?'],
...
const faq = [
  ['What is AI sourcing?', 'AI sourcing is the use of AI-assisted systems to help recruiters interpret roles, expand search language, build queries, discover or prioritize potential candidates, summarize evidence, and support outreach workflows. The useful boundary is assistance with search and evidence—not treating generated output as verified fact.'],
  ...
  ['Should the AI sourcing tool with the most candidates win?', 'No. Raw volume is not the same as useful discovery. Compare qualified yield, duplicate rate, unique contribution, evidence quality, review time, and workflow cost on the same requisitions.'],
  ['Can AI verify a security clearance from public data?', 'No. Public clearance language can be a sourcing breadcrumb, but it should not be converted into a verified clearance claim. Current status belongs in the authorized employer and security process.'],
    ...
    <main className="wrap article article-pro">
      <div className="article-hero-card">
        ...
        <div className="article-meta-grid">
          ...
          <div><span>Core metric</span><strong>Qualified unique contribution</strong></div>
      ...
      <div className="article-layout">
        ...
        <article className="article-main">
          <section id="short-answer"><h2>The short answer</h2><p>The best AI sourcing tool is not the one that generates the longest candidate list or the most polished summary. It is the one that improves qualified discovery on your real requisitions while keeping evidence, uncertainty, query logic, and consequential decisions inspectable by the recruiter. Test it against a manual baseline and against competing tools on the same work.</p></section>
          ...
          <div className="cta"><strong>Start with a transparent task:</strong> <Link href="/tools/boolean-generator/">run the free Boolean Search Generator</Link>, then compare its output with your current workflow.</div>
        </article>
      </div>
    </main>
  </>
