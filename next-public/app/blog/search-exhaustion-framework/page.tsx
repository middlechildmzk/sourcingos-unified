...
export const metadata: Metadata = {
  title: 'Search Exhaustion Framework: Have You Actually Searched the Market?',
  description,
...
const signals = [
  ...
  ['6. Adjacent-title yield', 'Does the adjacent-title lane still produce unique, credible leads? If it does, the requirement may be narrower than the work itself and that belongs in calibration.'],
