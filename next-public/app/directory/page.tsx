...
export const metadata = { title: 'Recruiting Tool Directory', description: 'Compare sourcing tools, contact finders, AI recruiting tools, ATS/CRM systems, and open-web sources.' }
