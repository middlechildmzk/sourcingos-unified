...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes=['','/tools','/tools/boolean-generator','/tools/xray-search','/tools/jd-search-strategy','/sources','/app/candidate-graph','/methods','/directory','/blog','/comparisons','/playbooks','/jobs','/jobs/submit','/jobs/guides','/privacy','/waitlist']
  return [
