...
const FIVE_BATCH = 'v40-7e-live-5'
const TEN_BATCH = 'v40-7e-live-10'
const FIFTY_BATCH = 'v40-7e-live-50'
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    if (!readiness.synthesisGateway && !readiness.synthesisParallel && !readiness.anthropic) {
