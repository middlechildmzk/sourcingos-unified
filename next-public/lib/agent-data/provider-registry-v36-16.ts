...
export function agentProviderStatusesV36_16(): AgentProviderStatusV36_16[] {
  ...
  return [
    ...
    status('brightdata', 'Bright Data', has(process.env.BRIGHTDATA_API_KEY), false, ['mcp', 'rest'], ['search_web', 'refresh_entity'], 'live', 'live', 'Credential is recognized. V36.16 will expose a narrow allowlisted live-web tool surface, not the entire MCP server.'),
