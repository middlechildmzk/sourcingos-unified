...
export const jobSourceRegistry: JobSourceDefinition[] = [
  ...
  },
  {
    ...
    label: 'OpenWebNinja real-time jobs',
    access: 'official_optional',
    enabledByDefault: true,
    persistEligible: false,
    termsNote: 'Configured API source for live hiring-market search. Keep employer/job facts separate from candidate evidence.',
    priority: 'high',
  },
  {
    id: 'adzuna',
    sourceType: 'adzuna',
    label: 'Adzuna recruiter jobs',
    access: 'official_optional',
    enabledByDefault: true,
    persistEligible: false,
    termsNote: 'Configured Adzuna API source. Retain Jobs by Adzuna attribution and provider-authorized redirect links; persistence requires separate licensing review.',
    priority: 'high',
  },
  {
    id: 'greenhouse',
